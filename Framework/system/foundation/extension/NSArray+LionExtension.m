...
@implementation NSArray(LionExtension)
...
@implementation NSMutableArray(LionExtension)
...
TEST_CASE( NSArray_LionExtension )
{
    TIMES( 3 )
    {
...
TEST_CASE( NSMutableArray_LionExtension )
{
    //	+ (NSMutableArray *)nonRetainingArray;	// copy from Three20
    //
    //	- (NSMutableArray *)pushHead:(NSObject *)obj;
