...
DEF_PACKAGE( LionPackage_System, LionSystemInfo, info );

#pragma mark -

@implementation LionSystemInfo

DEF_SINGLETON( LionSystemInfo );
...
+ (BOOL)isPhone35
{
    ...
    {
        return [LionSystemInfo isScreenSize:CGSizeMake(320, 480)];
    }
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
+ (BOOL)isPhoneRetina35
{
    ...
    {
        return [LionSystemInfo isScreenSize:CGSizeMake(640, 960)];
    }
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
+ (BOOL)isPhoneRetina4
{
    ...
    {
        return [LionSystemInfo isScreenSize:CGSizeMake(640, 1136)];
    }
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [LionSystemInfo isScreenSize:CGSizeMake(768, 1024)];
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
}
...
{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [LionSystemInfo isScreenSize:CGSizeMake(1536, 2048)];
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
}
...
TEST_CASE( LionSystemInfo_iOS )
{
    TIMES( 3 )
    {
        EXPECTED( [LionSystemInfo OSVersion] );
        EXPECTED( [LionSystemInfo appVersion] );
        EXPECTED( [LionSystemInfo deviceModel] );
        EXPECTED( [LionSystemInfo deviceUUID] );
        
        //		if ( [LionSystemInfo isJailBroken] )
        //		{
        //			EXPECTED( [LionSystemInfo jailBreaker] );
        //		}
    }
}
TEST_CASE_END
...
TEST_CASE( LionSystemInfo_MacOS )
{
    TIMES( 3 )
    {
        EXPECTED( [LionSystemInfo OSVersion] );
