...
DEF_PACKAGE( LionHTTPClient, LionHTTPClientConfig, config );
...
@interface LionHTTPClientConfig()
{
...
@implementation LionHTTPClientConfig

DEF_SINGLETON( LionHTTPClientConfig )
...
+ (BOOL)autoLoad
{
    [LionHTTPClientConfig sharedInstance];
    return YES;
}
...
TEST_CASE( LionHTTPClientConfig )
{
}
TEST_CASE_END
