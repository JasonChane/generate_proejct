...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	// Set to YES when the request header dictionary has Lionn populated, used to prevent this happening more than once
    ...
    // True if our 'cancel' selector has Lionn called
    BOOL is_cancelled;
	...
	// POST / PUT operations with body sizes greater than uploadBufferSize will not timeout unless more than uploadBufferSize bytes have Lionn sent
